...
输入“老黄历”随机抽取一对宜忌事项
'''
goodList = ["向阿苟表白","东风牛逼！","和弧弧贴贴","和吼姆一起提桶跑路","摸Create 101","造自动化流水线","种小麦","种马铃薯","种胡萝卜","养动物","打末影龙","吃饱喝足","摸了"]
badList = ["上原神贴吧PVP","和微博女拳对线","上知乎键政","看嘭哈布打手冲","在pixiv找色图","看真夏夜的银梦","看潮汕英豪传","看cookie⭐","当乐子人"]
